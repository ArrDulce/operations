...
<head>
    <meta charset="UTF-8">
    <title>Generar Hash SHA256</title>
    <style>
        ...
        .resultado { padding: 15px; background-color: #c6f6d5; color: #22543d; border-radius: 4px; font-weight: bold; text-align: center; margin-bottom: 15px; word-break: break-all; }
    </style>
</head>
<body>
    <div class="card">
        <h2>Generador SHA256</h2>
        ...
        @if(isset($resultado))
            <div class="resultado">
                Hash generado:<br> 
                <span style="font-weight: normal;">{{ $resultado }}</span>
            </div>
        @endif
